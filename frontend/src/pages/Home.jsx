...
function Home() {
  ...
  // Handle loading state and visibility
  useEffect(() => {
    if (!loading) {
      setIsVisible(true); // Set to true after loading completes
    }
  }, [loading]);
  ...
  return (
    <div>
      <div className={`home-container ${isVisible ? 'fade-in' : 'opacity-0'} transition-opacity duration-500`}>
        ...
        {/* Add margin to HomeCards component */}
        <div className="mt-12">
          <HomeCards />
        </div>
      </div>
